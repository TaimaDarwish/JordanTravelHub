<!-- <div class="container mx-auto px-4 py-8 bg-yellow-100 rounded-lg shadow-lg">
    ...
    <button id="trip-details-button" class="bg-yellow-600 text-white py-2 px-4 rounded-lg mt-5 mb-4 hover:bg-yellow-700 transition-colors shadow-md">
    ...
    <div id="trip-details" class="hidden mb-6 p-4 bg-white rounded-lg shadow-lg">
        ...
        @empty
            <p class="text-lg text-yellow-800">No trip options available.</p>
        @endforelse
    </div>
</div>
